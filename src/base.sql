...
Source Database       : flyfox_base

Target Server Type    : MYSQL
Target Server Version : 80015
File Encoding         : 65001

Date: 2019-11-23 22:05:00
*/
...
CREATE TABLE `sys_admin` (
  ...
  `AdminName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '登录名',
  `Password` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '密码',
  `RealName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '姓名',
  `RoleID` char(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '角色ID',
  `IsSuper` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否超级管理员(不验证权限)',
  `CreateBy` int(11) DEFAULT '0' COMMENT '创建人',
  `CreateTime` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户';

-- ----------------------------
-- Records of sys_admin
-- ----------------------------
INSERT INTO `sys_admin` VALUES ('1', 'admin', 'BPhGlDvNlCcpSFjw4l7dbn9h/sz5Lv/CU23CJidxzbeYVrCof047IwhvrgnGCmyGOdhTV84Pi5k5EElbSp1W/Pzk3jFyFWF2LnSIJrZjcszTeu3leusrg1+ePgLrJAPRqt9iFC4GST3/0uCl8CoEQw1BY38GN+AYOvbN43VtWn4=', '超级管理员', '', '', '0', '2018-06-15 17:41:07');
...
CREATE TABLE `sys_auth` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `AuthType` tinyint(4) NOT NULL COMMENT '权限类型(1-模块 2-主窗体 3-工具栏)',
  `AuthName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '权限名称',
  `AuthCode` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '权限编码',
  `ParentID` int(11) DEFAULT '0' COMMENT '父ID',
  `Url` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Url',
  `IconClass` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `Sort` int(11) NOT NULL DEFAULT '999' COMMENT '排序',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户权限';

-- ----------------------------
-- Records of sys_auth
-- ----------------------------
INSERT INTO `sys_auth` VALUES ('1', '1', '系统管理', 'SysManage', '0', '', 'layui-icon-chuangkou', '99');
INSERT INTO `sys_auth` VALUES ('2', '2', '用户列表', 'Sys.AdminList', '1', '/Sys/AdminList', null, '1');
INSERT INTO `sys_auth` VALUES ('3', '3', '添加/编辑用户', 'Sys.AdminAdd', '2', '/Sys/AdminAdd', null, '1');
INSERT INTO `sys_auth` VALUES ('4', '3', '删除用户', 'Sys.AdminDelete', '2', '/Sys/AdminDelete', '', '2');
INSERT INTO `sys_auth` VALUES ('5', '2', '角色列表', 'Sys.RoleList', '1', '/Sys/RoleList', null, '2');
INSERT INTO `sys_auth` VALUES ('6', '3', '添加/编辑角色', 'Sys.RoleAdd', '5', '/Sys/RoleAdd', '', '1');
INSERT INTO `sys_auth` VALUES ('7', '3', '删除角色', 'Sys.RoleDelete', '5', '/Sys/RoleDelete', '', '2');
INSERT INTO `sys_auth` VALUES ('8', '2', '权限列表', 'Sys.AuthList', '1', '/Sys/AuthList', '', '3');
INSERT INTO `sys_auth` VALUES ('9', '3', '添加/编辑权限', 'Sys.AuthAdd', '8', '/Sys/AuthAdd', '', '1');
INSERT INTO `sys_auth` VALUES ('10', '3', '删除权限', 'Sys.AuthDelete', '8', '/Sys/AuthDelete', '', '2');
INSERT INTO `sys_auth` VALUES ('11', '3', '修改密码', 'Sys.AdminPwd', '2', '/Sys/AdminPwd', null, '3');
...
CREATE TABLE `sys_city` (
  ...
  `Spell` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `FirstLetter` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ZipCode` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ProvinceID` int(11) DEFAULT NULL,
  `IsHot` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否热门',
  `IsOpen` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否开放',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=347 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='城市信息';

-- ----------------------------
-- Records of sys_city
-- ----------------------------
INSERT INTO `sys_city` VALUES ('1', '北京市', 'BeJing', 'B', '100000', '1', '', '');
INSERT INTO `sys_city` VALUES ('2', '天津市', 'TianJin', 'T', '100000', '2', '\0', '\0');
INSERT INTO `sys_city` VALUES ('3', '石家庄市', 'ShiJiaZhuang', 'S', '050000', '3', '\0', '\0');
INSERT INTO `sys_city` VALUES ('4', '唐山市', 'TangShan', 'T', '063000', '3', '\0', '\0');
INSERT INTO `sys_city` VALUES ('5', '秦皇岛市', 'QinHuangDao', 'Q', '066000', '3', '\0', '\0');
INSERT INTO `sys_city` VALUES ('6', '邯郸市', 'HanDan', 'H', '056000', '3', '\0', '\0');
INSERT INTO `sys_city` VALUES ('7', '邢台市', 'XingTai', 'X', '054000', '3', '\0', '\0');
INSERT INTO `sys_city` VALUES ('8', '保定市', 'BaoDing', 'B', '071000', '3', '\0', '\0');
INSERT INTO `sys_city` VALUES ('9', '张家口市', 'ZhangJiaKou', 'Z', '075000', '3', '\0', '\0');
INSERT INTO `sys_city` VALUES ('10', '承德市', 'ChengDe', 'C', '067000', '3', '\0', '\0');
INSERT INTO `sys_city` VALUES ('11', '沧州市', 'CangZhou', 'C', '061000', '3', '\0', '\0');
INSERT INTO `sys_city` VALUES ('12', '廊坊市', 'LangFang', 'L', '065000', '3', '\0', '\0');
INSERT INTO `sys_city` VALUES ('13', '衡水市', 'HengShui', 'H', '053000', '3', '\0', '\0');
INSERT INTO `sys_city` VALUES ('14', '太原市', 'TaiYuan', 'T', '030000', '4', '\0', '\0');
INSERT INTO `sys_city` VALUES ('15', '大同市', 'DaTong', 'D', '037000', '4', '\0', '\0');
INSERT INTO `sys_city` VALUES ('16', '阳泉市', 'YangQuan', 'Y', '045000', '4', '\0', '\0');
INSERT INTO `sys_city` VALUES ('17', '长治市', 'ChangZhi', 'C', '046000', '4', '\0', '\0');
INSERT INTO `sys_city` VALUES ('18', '晋城市', 'JinCheng', 'J', '048000', '4', '\0', '\0');
INSERT INTO `sys_city` VALUES ('19', '朔州市', 'ShuoZhou', 'S', '036000', '4', '\0', '\0');
INSERT INTO `sys_city` VALUES ('20', '晋中市', 'JinZhong', 'J', '030600', '4', '\0', '\0');
INSERT INTO `sys_city` VALUES ('21', '运城市', 'YunCheng', 'Y', '044000', '4', '\0', '\0');
INSERT INTO `sys_city` VALUES ('22', '忻州市', 'XinZhou', 'X', '034000', '4', '\0', '\0');
INSERT INTO `sys_city` VALUES ('23', '临汾市', 'LinFen', 'L', '041000', '4', '\0', '\0');
INSERT INTO `sys_city` VALUES ('24', '吕梁市', 'LvLiang', 'L', '030500', '4', '\0', '\0');
INSERT INTO `sys_city` VALUES ('25', '呼和浩特市', 'HuHeHaoTe', 'H', '010000', '5', '\0', '\0');
INSERT INTO `sys_city` VALUES ('26', '包头市', 'BaoTou', 'B', '014000', '5', '\0', '\0');
INSERT INTO `sys_city` VALUES ('27', '乌海市', 'WuHai', 'W', '016000', '5', '\0', '\0');
INSERT INTO `sys_city` VALUES ('28', '赤峰市', 'ChiFeng', 'C', '024000', '5', '\0', '\0');
INSERT INTO `sys_city` VALUES ('29', '通辽市', 'TongLiao', 'T', '028000', '5', '\0', '\0');
INSERT INTO `sys_city` VALUES ('30', '鄂尔多斯市', 'EErDuoSi', 'E', '010300', '5', '\0', '\0');
INSERT INTO `sys_city` VALUES ('31', '呼伦贝尔市', 'HuLunBeiEr', 'H', '021000', '5', '\0', '\0');
INSERT INTO `sys_city` VALUES ('32', '巴彦淖尔市', 'BaYanNaoEr', 'B', '014400', '5', '\0', '\0');
INSERT INTO `sys_city` VALUES ('33', '乌兰察布市', 'WuLanChaBu', 'W', '011800', '5', '\0', '\0');
INSERT INTO `sys_city` VALUES ('34', '兴安盟', 'XingAnMeng', 'X', '137500', '5', '\0', '\0');
INSERT INTO `sys_city` VALUES ('35', '锡林郭勒盟', 'XiLinGuoLeMeng', 'X', '011100', '5', '\0', '\0');
INSERT INTO `sys_city` VALUES ('36', '阿拉善盟', 'ALaShanMeng', 'A', '016000', '5', '\0', '\0');
INSERT INTO `sys_city` VALUES ('37', '沈阳市', 'ShenYang', 'S', '110000', '6', '\0', '\0');
INSERT INTO `sys_city` VALUES ('38', '大连市', 'DaLian', 'D', '116000', '6', '', '');
INSERT INTO `sys_city` VALUES ('39', '鞍山市', 'AnShan', 'A', '114000', '6', '\0', '\0');
INSERT INTO `sys_city` VALUES ('40', '抚顺市', 'FuShun', 'F', '113000', '6', '\0', '\0');
INSERT INTO `sys_city` VALUES ('41', '本溪市', 'BenXi', 'B', '117000', '6', '\0', '\0');
INSERT INTO `sys_city` VALUES ('42', '丹东市', 'DanDong', 'D', '118000', '6', '\0', '\0');
INSERT INTO `sys_city` VALUES ('43', '锦州市', 'JinZhou', 'J', '121000', '6', '\0', '\0');
INSERT INTO `sys_city` VALUES ('44', '营口市', 'YingKou', 'Y', '115000', '6', '\0', '\0');
INSERT INTO `sys_city` VALUES ('45', '阜新市', 'FuXin', 'F', '123000', '6', '\0', '\0');
INSERT INTO `sys_city` VALUES ('46', '辽阳市', 'LiaoYang', 'L', '111000', '6', '\0', '\0');
INSERT INTO `sys_city` VALUES ('47', '盘锦市', 'PanJin', 'P', '124000', '6', '\0', '\0');
INSERT INTO `sys_city` VALUES ('48', '铁岭市', 'TieLing', 'T', '112000', '6', '\0', '\0');
INSERT INTO `sys_city` VALUES ('49', '朝阳市', 'ChaoYang', 'C', '122000', '6', '\0', '\0');
INSERT INTO `sys_city` VALUES ('50', '葫芦岛市', 'HuLuDao', 'H', '125000', '6', '\0', '\0');
INSERT INTO `sys_city` VALUES ('51', '长春市', 'ChangChun', 'C', '130000', '7', '\0', '\0');
INSERT INTO `sys_city` VALUES ('52', '吉林市', 'JiLin', 'J', '132000', '7', '\0', '\0');
INSERT INTO `sys_city` VALUES ('53', '四平市', 'SiPing', 'S', '136000', '7', '\0', '\0');
INSERT INTO `sys_city` VALUES ('54', '辽源市', 'LiaoYuan', 'L', '136200', '7', '\0', '\0');
INSERT INTO `sys_city` VALUES ('55', '通化市', 'TongHua', 'T', '134000', '7', '\0', '\0');
INSERT INTO `sys_city` VALUES ('56', '白山市', 'BaiShan', 'B', '134300', '7', '\0', '\0');
INSERT INTO `sys_city` VALUES ('57', '松原市', 'SongYuan', 'S', '131100', '7', '\0', '\0');
INSERT INTO `sys_city` VALUES ('58', '白城市', 'BaiCheng', 'B', '137000', '7', '\0', '\0');
INSERT INTO `sys_city` VALUES ('59', '延边朝鲜族自治州', 'YanBianChaoXianZuZiZhiZhou', 'Y', '133000', '7', '\0', '\0');
INSERT INTO `sys_city` VALUES ('60', '哈尔滨市', 'HaErBin', 'H', '150000', '8', '\0', '\0');
INSERT INTO `sys_city` VALUES ('61', '齐齐哈尔市', 'QiQiHaEr', 'Q', '161000', '8', '\0', '\0');
INSERT INTO `sys_city` VALUES ('62', '鸡西市', 'JiXi', 'J', '158100', '8', '\0', '\0');
INSERT INTO `sys_city` VALUES ('63', '鹤岗市', 'HeGang', 'H', '154100', '8', '\0', '\0');
INSERT INTO `sys_city` VALUES ('64', '双鸭山市', 'ShuangYaShan', 'S', '155100', '8', '\0', '\0');
INSERT INTO `sys_city` VALUES ('65', '大庆市', 'DaQing', 'D', '163000', '8', '\0', '\0');
INSERT INTO `sys_city` VALUES ('66', '伊春市', 'YiChun', 'Y', '152300', '8', '\0', '\0');
INSERT INTO `sys_city` VALUES ('67', '佳木斯市', 'JiaMuSi', 'J', '154000', '8', '\0', '\0');
INSERT INTO `sys_city` VALUES ('68', '七台河市', 'QiTaiHe', 'Q', '154600', '8', '\0', '\0');
INSERT INTO `sys_city` VALUES ('69', '牡丹江市', 'MuDanJiang', 'M', '157000', '8', '\0', '\0');
INSERT INTO `sys_city` VALUES ('70', '黑河市', 'HeiHe', 'H', '164300', '8', '\0', '\0');
INSERT INTO `sys_city` VALUES ('71', '绥化市', 'SuiHua', 'S', '152000', '8', '\0', '\0');
INSERT INTO `sys_city` VALUES ('72', '大兴安岭地区', 'DaXingAnLingDiQu', 'D', '165000', '8', '\0', '\0');
INSERT INTO `sys_city` VALUES ('73', '上海市', 'ShangHai', 'S', '200000', '9', '', '');
INSERT INTO `sys_city` VALUES ('74', '南京市', 'NanJing', 'N', '210000', '10', '\0', '\0');
INSERT INTO `sys_city` VALUES ('75', '无锡市', 'WuXi', 'W', '214000', '10', '\0', '\0');
INSERT INTO `sys_city` VALUES ('76', '徐州市', 'XuZhou', 'X', '221000', '10', '\0', '\0');
INSERT INTO `sys_city` VALUES ('77', '常州市', 'ChangZhou', 'C', '213000', '10', '\0', '\0');
INSERT INTO `sys_city` VALUES ('78', '苏州市', 'SuZhou', 'S', '215000', '10', '', '');
INSERT INTO `sys_city` VALUES ('79', '南通市', 'NanTong', 'N', '226000', '10', '\0', '\0');
INSERT INTO `sys_city` VALUES ('80', '连云港市', 'LianYunGang', 'L', '222000', '10', '\0', '\0');
INSERT INTO `sys_city` VALUES ('81', '淮安市', 'HuaiAn', 'H', '223200', '10', '\0', '\0');
INSERT INTO `sys_city` VALUES ('82', '盐城市', 'YanCheng', 'Y', '224000', '10', '\0', '\0');
INSERT INTO `sys_city` VALUES ('83', '扬州市', 'YangZhou', 'Y', '225000', '10', '\0', '\0');
INSERT INTO `sys_city` VALUES ('84', '镇江市', 'ZhenJiang', 'Z', '212000', '10', '\0', '\0');
INSERT INTO `sys_city` VALUES ('85', '泰州市', 'TaiZhou', 'T', '225300', '10', '\0', '\0');
INSERT INTO `sys_city` VALUES ('86', '宿迁市', 'SuQian', 'S', '223800', '10', '\0', '\0');
INSERT INTO `sys_city` VALUES ('87', '杭州市', 'HangZhou', 'H', '310000', '11', '', '');
INSERT INTO `sys_city` VALUES ('88', '宁波市', 'NingBo', 'N', '315000', '11', '\0', '\0');
INSERT INTO `sys_city` VALUES ('89', '温州市', 'WenZhou', 'W', '325000', '11', '\0', '\0');
INSERT INTO `sys_city` VALUES ('90', '嘉兴市', 'JiaXing', 'J', '314000', '11', '\0', '\0');
INSERT INTO `sys_city` VALUES ('91', '湖州市', 'HuZhou', 'H', '313000', '11', '\0', '\0');
INSERT INTO `sys_city` VALUES ('92', '绍兴市', 'ShaoXing', 'S', '312000', '11', '\0', '\0');
INSERT INTO `sys_city` VALUES ('93', '金华市', 'JinHua', 'J', '321000', '11', '\0', '\0');
INSERT INTO `sys_city` VALUES ('94', '衢州市', 'ZuoZhou', 'Z', '324000', '11', '\0', '\0');
INSERT INTO `sys_city` VALUES ('95', '舟山市', 'ZhouShan', 'Z', '316000', '11', '\0', '\0');
INSERT INTO `sys_city` VALUES ('96', '台州市', 'TaiZhou', 'T', '318000', '11', '\0', '\0');
INSERT INTO `sys_city` VALUES ('97', '丽水市', 'LiShui', 'L', '323000', '11', '\0', '\0');
INSERT INTO `sys_city` VALUES ('98', '合肥市', 'HeFei', 'H', '230000', '12', '', '');
INSERT INTO `sys_city` VALUES ('99', '芜湖市', 'WuHu', 'W', '241000', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('100', '蚌埠市', 'BangBu', 'B', '233000', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('101', '淮南市', 'HuaiNan', 'H', '232000', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('102', '马鞍山市', 'MaAnShan', 'M', '243000', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('103', '淮北市', 'HuaiBei', 'H', '235000', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('104', '铜陵市', 'TongLing', 'T', '244000', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('105', '安庆市', 'AnQing', 'A', '246000', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('106', '黄山市', 'HuangShan', 'H', '242700', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('107', '滁州市', 'ChuZhou', 'C', '239000', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('108', '阜阳市', 'FuYang', 'F', '236100', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('109', '宿州市', 'SuZhou', 'S', '234100', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('111', '六安市', 'LiuAn', 'L', '237000', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('112', '亳州市', 'ZuoZhou', 'Z', '236800', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('113', '池州市', 'ChiZhou', 'C', '247100', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('114', '宣城市', 'XuanCheng', 'X', '366000', '12', '\0', '\0');
INSERT INTO `sys_city` VALUES ('115', '福州市', 'FuZhou', 'F', '350000', '13', '\0', '\0');
INSERT INTO `sys_city` VALUES ('116', '厦门市', 'XiaMen', 'X', '361000', '13', '\0', '\0');
INSERT INTO `sys_city` VALUES ('117', '莆田市', 'PuTian', 'P', '351100', '13', '\0', '\0');
INSERT INTO `sys_city` VALUES ('118', '三明市', 'SanMing', 'S', '365000', '13', '\0', '\0');
INSERT INTO `sys_city` VALUES ('119', '泉州市', 'QuanZhou', 'Q', '362000', '13', '\0', '\0');
INSERT INTO `sys_city` VALUES ('120', '漳州市', 'ZhangZhou', 'Z', '363000', '13', '\0', '\0');
INSERT INTO `sys_city` VALUES ('121', '南平市', 'NanPing', 'N', '353000', '13', '\0', '\0');
INSERT INTO `sys_city` VALUES ('122', '龙岩市', 'LongYan', 'L', '364000', '13', '\0', '\0');
INSERT INTO `sys_city` VALUES ('123', '宁德市', 'NingDe', 'N', '352100', '13', '\0', '\0');
INSERT INTO `sys_city` VALUES ('124', '南昌市', 'NanChang', 'N', '330000', '14', '\0', '\0');
INSERT INTO `sys_city` VALUES ('125', '景德镇市', 'JingDeZhen', 'J', '333000', '14', '\0', '\0');
INSERT INTO `sys_city` VALUES ('126', '萍乡市', 'PingXiang', 'P', '337000', '14', '\0', '\0');
INSERT INTO `sys_city` VALUES ('127', '九江市', 'JiuJiang', 'J', '332000', '14', '\0', '\0');
INSERT INTO `sys_city` VALUES ('128', '新余市', 'XinYu', 'X', '338000', '14', '\0', '\0');
INSERT INTO `sys_city` VALUES ('129', '鹰潭市', 'YingTan', 'Y', '335000', '14', '\0', '\0');
INSERT INTO `sys_city` VALUES ('130', '赣州市', 'GanZhou', 'G', '341000', '14', '\0', '\0');
INSERT INTO `sys_city` VALUES ('131', '吉安市', 'JiAn', 'J', '343000', '14', '\0', '\0');
INSERT INTO `sys_city` VALUES ('132', '宜春市', 'YiChun', 'Y', '336000', '14', '\0', '\0');
INSERT INTO `sys_city` VALUES ('133', '抚州市', 'FuZhou', 'F', '332900', '14', '\0', '\0');
INSERT INTO `sys_city` VALUES ('134', '上饶市', 'ShangRao', 'S', '334000', '14', '\0', '\0');
INSERT INTO `sys_city` VALUES ('135', '济南市', 'JiNan', 'J', '250000', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('136', '青岛市', 'QingDao', 'Q', '266000', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('137', '淄博市', 'ZiBo', 'Z', '255000', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('138', '枣庄市', 'ZaoZhuang', 'Z', '277100', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('139', '东营市', 'DongYing', 'D', '257000', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('140', '烟台市', 'YanTai', 'Y', '264000', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('141', '潍坊市', 'WeiFang', 'W', '261000', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('142', '济宁市', 'JiNing', 'J', '272100', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('143', '泰安市', 'TaiAn', 'T', '271000', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('144', '威海市', 'WeiHai', 'W', '265700', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('145', '日照市', 'RiZhao', 'R', '276800', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('146', '莱芜市', 'LaiWu', 'L', '271100', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('147', '临沂市', 'LinYi', 'L', '276000', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('148', '德州市', 'DeZhou', 'D', '253000', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('149', '聊城市', 'LiaoCheng', 'L', '252000', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('150', '滨州市', 'BinZhou', 'B', '256600', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('151', '荷泽市', 'HeZe', 'H', '255000', '15', '\0', '\0');
INSERT INTO `sys_city` VALUES ('152', '郑州市', 'ZhengZhou', 'Z', '450000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('153', '开封市', 'KaiFeng', 'K', '475000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('154', '洛阳市', 'LuoYang', 'L', '471000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('155', '平顶山市', 'PingDingShan', 'P', '467000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('156', '安阳市', 'AnYang', 'A', '454900', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('157', '鹤壁市', 'HeBi', 'H', '456600', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('158', '新乡市', 'XinXiang', 'X', '453000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('159', '焦作市', 'JiaoZuo', 'J', '454100', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('160', '濮阳市', 'ZuoYang', 'Z', '457000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('161', '许昌市', 'XuChang', 'X', '461000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('162', '漯河市', 'ZuoHe', 'Z', '462000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('163', '三门峡市', 'SanMenXia', 'S', '472000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('164', '南阳市', 'NanYang', 'N', '473000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('165', '商丘市', 'ShangQiu', 'S', '476000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('166', '信阳市', 'XinYang', 'X', '464000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('167', '周口市', 'ZhouKou', 'Z', '466000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('168', '驻马店市', 'ZhuMaDian', 'Z', '463000', '16', '\0', '\0');
INSERT INTO `sys_city` VALUES ('169', '武汉市', 'WuHan', 'W', '430000', '17', '', '');
INSERT INTO `sys_city` VALUES ('170', '黄石市', 'HuangShi', 'H', '435000', '17', '\0', '\0');
INSERT INTO `sys_city` VALUES ('171', '十堰市', 'ShiYan', 'S', '442000', '17', '\0', '\0');
INSERT INTO `sys_city` VALUES ('172', '宜昌市', 'YiChang', 'Y', '443000', '17', '\0', '\0');
INSERT INTO `sys_city` VALUES ('173', '襄阳市', 'XiangYang', 'X', '441000', '17', '\0', '\0');
INSERT INTO `sys_city` VALUES ('174', '鄂州市', 'EZhou', 'E', '436000', '17', '\0', '\0');
INSERT INTO `sys_city` VALUES ('175', '荆门市', 'JingMen', 'J', '448000', '17', '\0', '\0');
INSERT INTO `sys_city` VALUES ('176', '孝感市', 'XiaoGan', 'X', '432100', '17', '\0', '\0');
INSERT INTO `sys_city` VALUES ('177', '荆州市', 'JingZhou', 'J', '434000', '17', '\0', '\0');
INSERT INTO `sys_city` VALUES ('178', '黄冈市', 'HuangGang', 'H', '438000', '17', '\0', '\0');
INSERT INTO `sys_city` VALUES ('179', '咸宁市', 'XianNing', 'X', '437000', '17', '\0', '\0');
INSERT INTO `sys_city` VALUES ('180', '随州市', 'SuiZhou', 'S', '441300', '17', '\0', '\0');
INSERT INTO `sys_city` VALUES ('181', '恩施土家族苗族自治州', 'EnShiTuJiaZuMiaoZuZiZhiZhou', 'E', '445000', '17', '\0', '\0');
INSERT INTO `sys_city` VALUES ('182', '神农架', 'ShenNongJia', 'S', '442400', '17', '\0', '\0');
INSERT INTO `sys_city` VALUES ('183', '长沙市', 'ChangSha', 'C', '410000', '18', '', '');
INSERT INTO `sys_city` VALUES ('184', '株洲市', 'ZhuZhou', 'Z', '412000', '18', '\0', '\0');
INSERT INTO `sys_city` VALUES ('185', '湘潭市', 'XiangTan', 'X', '411100', '18', '\0', '\0');
INSERT INTO `sys_city` VALUES ('186', '衡阳市', 'HengYang', 'H', '421000', '18', '\0', '\0');
INSERT INTO `sys_city` VALUES ('187', '邵阳市', 'ShaoYang', 'S', '422000', '18', '\0', '\0');
INSERT INTO `sys_city` VALUES ('188', '岳阳市', 'YueYang', 'Y', '414000', '18', '\0', '\0');
INSERT INTO `sys_city` VALUES ('189', '常德市', 'ChangDe', 'C', '415000', '18', '\0', '\0');
INSERT INTO `sys_city` VALUES ('190', '张家界市', 'ZhangJiaJie', 'Z', '427000', '18', '\0', '\0');
INSERT INTO `sys_city` VALUES ('191', '益阳市', 'YiYang', 'Y', '413000', '18', '\0', '\0');
INSERT INTO `sys_city` VALUES ('192', '郴州市', 'ChenZhou', 'C', '423000', '18', '\0', '\0');
INSERT INTO `sys_city` VALUES ('193', '永州市', 'YongZhou', 'Y', '425000', '18', '\0', '\0');
INSERT INTO `sys_city` VALUES ('194', '怀化市', 'HuaiHua', 'H', '418000', '18', '\0', '\0');
INSERT INTO `sys_city` VALUES ('195', '娄底市', 'LouDi', 'L', '417000', '18', '\0', '\0');
INSERT INTO `sys_city` VALUES ('196', '湘西土家族苗族自治州', 'XiangXiTuJiaZuMiaoZuZiZhiZhou', 'X', '416000', '18', '\0', '\0');
INSERT INTO `sys_city` VALUES ('197', '广州市', 'GuangZhou', 'G', '510000', '19', '', '');
INSERT INTO `sys_city` VALUES ('198', '韶关市', 'ShaoGuan', 'S', '521000', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('199', '深圳市', 'ShenZhen', 'S', '518000', '19', '', '');
INSERT INTO `sys_city` VALUES ('200', '珠海市', 'ZhuHai', 'Z', '519000', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('201', '汕头市', 'ShanTou', 'S', '515000', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('202', '佛山市', 'FoShan', 'F', '528000', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('203', '江门市', 'JiangMen', 'J', '529000', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('204', '湛江市', 'ZhanJiang', 'Z', '524000', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('205', '茂名市', 'MaoMing', 'M', '525000', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('206', '肇庆市', 'ZhaoQing', 'Z', '526000', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('207', '惠州市', 'HuiZhou', 'H', '516000', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('208', '梅州市', 'MeiZhou', 'M', '514000', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('209', '汕尾市', 'ShanWei', 'S', '516600', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('210', '河源市', 'HeYuan', 'H', '517000', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('211', '阳江市', 'YangJiang', 'Y', '529500', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('212', '清远市', 'QingYuan', 'Q', '511500', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('213', '东莞市', 'DongZuo', 'D', '511700', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('214', '中山市', 'ZhongShan', 'Z', '528400', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('215', '潮州市', 'ChaoZhou', 'C', '515600', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('216', '揭阳市', 'JieYang', 'J', '522000', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('217', '云浮市', 'YunFu', 'Y', '527300', '19', '\0', '\0');
INSERT INTO `sys_city` VALUES ('218', '南宁市', 'NanNing', 'N', '530000', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('219', '柳州市', 'LiuZhou', 'L', '545000', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('220', '桂林市', 'GuiLin', 'G', '541000', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('221', '梧州市', 'WuZhou', 'W', '543000', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('222', '北海市', 'BeiHai', 'B', '536000', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('223', '防城港市', 'FangChengGang', 'F', '538000', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('224', '钦州市', 'QinZhou', 'Q', '535000', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('225', '贵港市', 'GuiGang', 'G', '537100', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('226', '玉林市', 'YuLin', 'Y', '537000', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('227', '百色市', 'BaiSe', 'B', '533000', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('228', '贺州市', 'HeZhou', 'H', '542800', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('229', '河池市', 'HeChi', 'H', '547000', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('230', '来宾市', 'LaiBin', 'L', '546100', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('231', '崇左市', 'ChongZuo', 'C', '532200', '20', '\0', '\0');
INSERT INTO `sys_city` VALUES ('232', '海口市', 'HaiKou', 'H', '570000', '21', '\0', '\0');
INSERT INTO `sys_city` VALUES ('233', '三沙市', 'SanSha', 'S', '572000', '21', '\0', '\0');
INSERT INTO `sys_city` VALUES ('234', '重庆市', 'ZhongQing', 'Z', '400000', '22', '\0', '\0');
INSERT INTO `sys_city` VALUES ('235', '成都市', 'ChengDu', 'C', '610000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('236', '自贡市', 'ZiGong', 'Z', '643000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('237', '攀枝花市', 'PanZhiHua', 'P', '617000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('238', '泸州市', 'ZuoZhou', 'Z', '646100', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('239', '德阳市', 'DeYang', 'D', '618000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('240', '绵阳市', 'MianYang', 'M', '621000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('241', '广元市', 'GuangYuan', 'G', '628000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('242', '遂宁市', 'SuiNing', 'S', '629000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('243', '内江市', 'NeiJiang', 'N', '641000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('244', '乐山市', 'LeShan', 'L', '614000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('245', '南充市', 'NanChong', 'N', '637000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('246', '眉山市', 'MeiShan', 'M', '612100', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('247', '宜宾市', 'YiBin', 'Y', '644000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('248', '广安市', 'GuangAn', 'G', '638000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('249', '达州市', 'DaZhou', 'D', '635000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('250', '雅安市', 'YaAn', 'Y', '625000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('251', '巴中市', 'BaZhong', 'B', '635500', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('252', '资阳市', 'ZiYang', 'Z', '641300', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('253', '阿坝藏族羌族自治州', 'ABaCangZuQiangZuZiZhiZhou', 'A', '624600', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('254', '甘孜藏族自治州', 'GanZiCangZuZiZhiZhou', 'G', '626000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('255', '凉山彝族自治州', 'LiangShanYiZuZiZhiZhou', 'L', '615000', '23', '\0', '\0');
INSERT INTO `sys_city` VALUES ('256', '贵阳市', 'GuiYang', 'G', '55000', '24', '\0', '\0');
INSERT INTO `sys_city` VALUES ('257', '六盘水市', 'LiuPanShui', 'L', '553000', '24', '\0', '\0');
INSERT INTO `sys_city` VALUES ('258', '遵义市', 'ZunYi', 'Z', '563000', '24', '\0', '\0');
INSERT INTO `sys_city` VALUES ('259', '安顺市', 'AnShun', 'A', '561000', '24', '\0', '\0');
INSERT INTO `sys_city` VALUES ('260', '铜仁市', 'TongRen', 'T', '554300', '24', '\0', '\0');
INSERT INTO `sys_city` VALUES ('261', '黔西南布依族苗族自治州', 'QianXiNanBuYiZuMiaoZuZiZhiZhou', 'Q', '551500', '24', '\0', '\0');
INSERT INTO `sys_city` VALUES ('262', '毕节市', 'BiJie', 'B', '551700', '24', '\0', '\0');
INSERT INTO `sys_city` VALUES ('263', '黔东南苗族侗族自治州', 'QianDongNanMiaoZuDongZuZiZhiZhou', 'Q', '551500', '24', '\0', '\0');
INSERT INTO `sys_city` VALUES ('264', '黔南布依族苗族自治州', 'QianNanBuYiZuMiaoZuZiZhiZhou', 'Q', '550100', '24', '\0', '\0');
INSERT INTO `sys_city` VALUES ('265', '昆明市', 'KunMing', 'K', '650000', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('266', '曲靖市', 'QuJing', 'Q', '655000', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('267', '玉溪市', 'YuXi', 'Y', '653100', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('268', '保山市', 'BaoShan', 'B', '678000', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('269', '昭通市', 'ZhaoTong', 'Z', '657000', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('270', '丽江市', 'LiJiang', 'L', '674100', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('271', '普洱市', 'PuEr', 'P', '665000', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('272', '临沧市', 'LinCang', 'L', '677000', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('273', '楚雄彝族自治州', 'ChuXiongYiZuZiZhiZhou', 'C', '675000', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('274', '红河哈尼族彝族自治州', 'HongHeHaNiZuYiZuZiZhiZhou', 'H', '654400', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('275', '文山壮族苗族自治州', 'WenShanZhuangZuMiaoZuZiZhiZhou', 'W', '663000', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('276', '西双版纳傣族自治州', 'XiShuangBanNaDaiZuZiZhiZhou', 'X', '666200', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('277', '大理白族自治州', 'DaLiBaiZuZiZhiZhou', 'D', '671000', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('278', '德宏傣族景颇族自治州', 'DeHongDaiZuJingPoZuZiZhiZhou', 'D', '678400', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('279', '怒江傈僳族自治州', 'NuJiangLiSuZuZiZhiZhou', 'N', '671400', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('280', '迪庆藏族自治州', 'DiQingCangZuZiZhiZhou', 'D', '674400', '25', '\0', '\0');
INSERT INTO `sys_city` VALUES ('281', '拉萨市', 'LaSa', 'L', '850000', '26', '\0', '\0');
INSERT INTO `sys_city` VALUES ('282', '昌都地区', 'ChangDuDiQu', 'C', '854000', '26', '\0', '\0');
INSERT INTO `sys_city` VALUES ('283', '山南地区', 'ShanNanDiQu', 'S', '856000', '26', '\0', '\0');
INSERT INTO `sys_city` VALUES ('284', '日喀则地区', 'RiKaZeDiQu', 'R', '857000', '26', '\0', '\0');
INSERT INTO `sys_city` VALUES ('285', '那曲地区', 'NaQuDiQu', 'N', '852000', '26', '\0', '\0');
INSERT INTO `sys_city` VALUES ('286', '阿里地区', 'ALiDiQu', 'A', '859100', '26', '\0', '\0');
INSERT INTO `sys_city` VALUES ('287', '林芝地区', 'LinZhiDiQu', 'L', '860100', '26', '\0', '\0');
INSERT INTO `sys_city` VALUES ('288', '西安市', 'XiAn', 'X', '710000', '27', '\0', '\0');
INSERT INTO `sys_city` VALUES ('289', '铜川市', 'TongChuan', 'T', '727000', '27', '\0', '\0');
INSERT INTO `sys_city` VALUES ('290', '宝鸡市', 'BaoJi', 'B', '721000', '27', '\0', '\0');
INSERT INTO `sys_city` VALUES ('291', '咸阳市', 'XianYang', 'X', '712000', '27', '\0', '\0');
INSERT INTO `sys_city` VALUES ('292', '渭南市', 'WeiNan', 'W', '714000', '27', '\0', '\0');
INSERT INTO `sys_city` VALUES ('293', '延安市', 'YanAn', 'Y', '716000', '27', '\0', '\0');
INSERT INTO `sys_city` VALUES ('294', '汉中市', 'HanZhong', 'H', '723000', '27', '\0', '\0');
INSERT INTO `sys_city` VALUES ('295', '榆林市', 'YuLin', 'Y', '719000', '27', '\0', '\0');
INSERT INTO `sys_city` VALUES ('296', '安康市', 'AnKang', 'A', '725000', '27', '\0', '\0');
INSERT INTO `sys_city` VALUES ('297', '商洛市', 'ShangLuo', 'S', '711500', '27', '\0', '\0');
INSERT INTO `sys_city` VALUES ('298', '兰州市', 'LanZhou', 'L', '730000', '28', '\0', '\0');
INSERT INTO `sys_city` VALUES ('300', '嘉峪关市', 'JiaYuGuan', 'J', '737100', '28', '\0', '\0');
INSERT INTO `sys_city` VALUES ('301', '白银市', 'BaiYin', 'B', '730900', '28', '\0', '\0');
INSERT INTO `sys_city` VALUES ('302', '天水市', 'TianShui', 'T', '741000', '28', '\0', '\0');
INSERT INTO `sys_city` VALUES ('303', '武威市', 'WuWei', 'W', '733000', '28', '\0', '\0');
INSERT INTO `sys_city` VALUES ('304', '张掖市', 'ZhangYe', 'Z', '734000', '28', '\0', '\0');
INSERT INTO `sys_city` VALUES ('305', '平凉市', 'PingLiang', 'P', '744000', '28', '\0', '\0');
INSERT INTO `sys_city` VALUES ('306', '酒泉市', 'JiuQuan', 'J', '735000', '28', '\0', '\0');
INSERT INTO `sys_city` VALUES ('307', '庆阳市', 'QingYang', 'Q', '744500', '28', '\0', '\0');
INSERT INTO `sys_city` VALUES ('308', '定西市', 'DingXi', 'D', '743000', '28', '\0', '\0');
INSERT INTO `sys_city` VALUES ('309', '陇南市', 'LongNan', 'L', '742100', '28', '\0', '\0');
INSERT INTO `sys_city` VALUES ('310', '临夏回族自治州', 'LinXiaHuiZuZiZhiZhou', 'L', '731100', '28', '\0', '\0');
INSERT INTO `sys_city` VALUES ('311', '甘南藏族自治州', 'GanNanCangZuZiZhiZhou', 'G', '747000', '28', '\0', '\0');
INSERT INTO `sys_city` VALUES ('312', '西宁市', 'XiNing', 'X', '810000', '29', '\0', '\0');
INSERT INTO `sys_city` VALUES ('313', '海东地区', 'HaiDongDiQu', 'H', '810600', '29', '\0', '\0');
INSERT INTO `sys_city` VALUES ('314', '海北藏族自治州', 'HaiBeiCangZuZiZhiZhou', 'H', '810300', '29', '\0', '\0');
INSERT INTO `sys_city` VALUES ('315', '黄南藏族自治州', 'HuangNanCangZuZiZhiZhou', 'H', '811300', '29', '\0', '\0');
INSERT INTO `sys_city` VALUES ('316', '海南藏族自治州', 'HaiNanCangZuZiZhiZhou', 'H', '813000', '29', '\0', '\0');
INSERT INTO `sys_city` VALUES ('317', '果洛藏族自治州', 'GuoLuoCangZuZiZhiZhou', 'G', '814000', '29', '\0', '\0');
INSERT INTO `sys_city` VALUES ('318', '玉树藏族自治州', 'YuShuCangZuZiZhiZhou', 'Y', '815000', '29', '\0', '\0');
INSERT INTO `sys_city` VALUES ('319', '海西蒙古族藏族自治州', 'HaiXiMengGuZuCangZuZiZhiZhou', 'H', '817000', '29', '\0', '\0');
INSERT INTO `sys_city` VALUES ('320', '银川市', 'YinChuan', 'Y', '750000', '30', '\0', '\0');
INSERT INTO `sys_city` VALUES ('321', '石嘴山市', 'ShiZuiShan', 'S', '753000', '30', '\0', '\0');
INSERT INTO `sys_city` VALUES ('322', '吴忠市', 'WuZhong', 'W', '751100', '30', '\0', '\0');
INSERT INTO `sys_city` VALUES ('323', '固原市', 'GuYuan', 'G', '756000', '30', '\0', '\0');
INSERT INTO `sys_city` VALUES ('324', '中卫市', 'ZhongWei', 'Z', '751700', '30', '\0', '\0');
INSERT INTO `sys_city` VALUES ('325', '乌鲁木齐市', 'WuLuMuQi', 'W', '830000', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('326', '克拉玛依市', 'KeLaMaYi', 'K', '834000', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('327', '吐鲁番地区', 'TuLuFanDiQu', 'T', '838000', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('328', '哈密地区', 'HaMiDiQu', 'H', '839000', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('329', '昌吉回族自治州', 'ChangJiHuiZuZiZhiZhou', 'C', '831100', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('330', '博尔塔拉蒙古自治州', 'BoErTaLaMengGuZiZhiZhou', 'B', '833400', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('331', '巴音郭楞蒙古自治州', 'BaYinGuoLengMengGuZiZhiZhou', 'B', '841000', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('332', '阿克苏地区', 'AKeSuDiQu', 'A', '843000', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('333', '克孜勒苏柯尔克孜自治州', 'KeZiLeSuKeErKeZiZiZhiZhou', 'K', '835600', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('334', '喀什地区', 'KaShiDiQu', 'K', '844000', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('335', '和田地区', 'HeTianDiQu', 'H', '848000', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('336', '伊犁哈萨克自治州', 'YiLiHaSaKeZiZhiZhou', 'Y', '833200', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('337', '塔城地区', 'TaChengDiQu', 'T', '834700', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('338', '阿勒泰地区', 'ALeTaiDiQu', 'A', '836500', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('339', '石河子市', 'ShiHeZi', 'S', '832000', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('340', '阿拉尔市', 'ALaEr', 'A', '843300', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('341', '图木舒克市', 'TuMuShuKe', 'T', '843900', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('342', '五家渠市', 'WuJiaQu', 'W', '831300', '31', '\0', '\0');
INSERT INTO `sys_city` VALUES ('343', '香港特别行政区', 'XiangGangTeBieXingZhengQu', 'X', '000000', '32', '\0', '\0');
INSERT INTO `sys_city` VALUES ('344', '澳门特别行政区', 'AoMenTeBieXingZhengQu', 'A', '000000', '33', '\0', '\0');
INSERT INTO `sys_city` VALUES ('345', '台湾省', 'TaiWan', 'T', '000000', '34', '\0', '\0');
INSERT INTO `sys_city` VALUES ('346', '三亚市', 'SanYa', 'S', 'NULL', '21', '\0', '\0');
...
CREATE TABLE `sys_dictdata` (
  ...
  `Value` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '值',
  `Sort` int(255) NOT NULL DEFAULT '99' COMMENT '排序',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='基础数据信息（存放基本不改动的数据）';

-- ----------------------------
-- Records of sys_dictdata
-- ----------------------------
INSERT INTO `sys_dictdata` VALUES ('1', '0', '汽车类型', null, '99');
INSERT INTO `sys_dictdata` VALUES ('2', '1', '新能源', '1', '99');
INSERT INTO `sys_dictdata` VALUES ('3', '1', '微型', '2', '99');
INSERT INTO `sys_dictdata` VALUES ('4', '1', '小型', '3', '99');
INSERT INTO `sys_dictdata` VALUES ('5', '1', '紧凑型', '4', '99');
INSERT INTO `sys_dictdata` VALUES ('6', '1', '中型', '5', '99');
INSERT INTO `sys_dictdata` VALUES ('7', '1', '中大型', '6', '99');
INSERT INTO `sys_dictdata` VALUES ('8', '1', '大型', '7', '99');
INSERT INTO `sys_dictdata` VALUES ('9', '1', 'SUV', '8', '99');
INSERT INTO `sys_dictdata` VALUES ('10', '1', 'MPV', '9', '99');
INSERT INTO `sys_dictdata` VALUES ('11', '1', '跑车', '10', '99');
INSERT INTO `sys_dictdata` VALUES ('12', '0', '汽车颜色', null, '99');
INSERT INTO `sys_dictdata` VALUES ('13', '12', '黑', '1', '99');
INSERT INTO `sys_dictdata` VALUES ('14', '12', '白', '2', '99');
INSERT INTO `sys_dictdata` VALUES ('15', '12', '银', '3', '99');
INSERT INTO `sys_dictdata` VALUES ('16', '12', '红', '4', '99');
INSERT INTO `sys_dictdata` VALUES ('17', '12', '蓝', '5', '99');
INSERT INTO `sys_dictdata` VALUES ('18', '12', '棕', '6', '99');
INSERT INTO `sys_dictdata` VALUES ('19', '12', '其他', '99', '99');
INSERT INTO `sys_dictdata` VALUES ('20', '0', '汽车排量', null, '99');
INSERT INTO `sys_dictdata` VALUES ('21', '20', '≤1.5L', '1', '99');
INSERT INTO `sys_dictdata` VALUES ('22', '20', '1.6-2.0L', '2', '99');
INSERT INTO `sys_dictdata` VALUES ('23', '20', '2.1-2.5L', '3', '99');
INSERT INTO `sys_dictdata` VALUES ('24', '20', '≥2.6L', '4', '99');
INSERT INTO `sys_dictdata` VALUES ('25', '0', '汽车座位数', null, '99');
INSERT INTO `sys_dictdata` VALUES ('26', '25', '2座', '1', '99');
INSERT INTO `sys_dictdata` VALUES ('27', '25', '3座', '2', '99');
INSERT INTO `sys_dictdata` VALUES ('28', '25', '4座', '3', '99');
INSERT INTO `sys_dictdata` VALUES ('29', '25', '5座', '4', '99');
INSERT INTO `sys_dictdata` VALUES ('30', '25', '6座', '5', '99');
INSERT INTO `sys_dictdata` VALUES ('31', '25', '7座', '6', '99');
INSERT INTO `sys_dictdata` VALUES ('32', '25', '7座以上', '7', '99');
INSERT INTO `sys_dictdata` VALUES ('33', '0', '汽车变速箱', null, '99');
INSERT INTO `sys_dictdata` VALUES ('34', '33', '手动', '1', '99');
INSERT INTO `sys_dictdata` VALUES ('35', '33', '自动', '2', '99');
INSERT INTO `sys_dictdata` VALUES ('36', '33', '手/自一体', '3', '99');
...
CREATE TABLE `sys_district` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `DistrictName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `CityID` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2887 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='地区信息';
...
INSERT INTO `sys_district` VALUES ('341', '白云鄂博矿区', '26');
...
INSERT INTO `sys_district` VALUES ('436', '沈北新区', '37');
...
INSERT INTO `sys_district` VALUES ('484', '北镇市', '43');
...
INSERT INTO `sys_district` VALUES ('565', '浑江区', '56');
INSERT INTO `sys_district` VALUES ('566', '江源区', '56');
INSERT INTO `sys_district` VALUES ('567', '抚松县', '56');
INSERT INTO `sys_district` VALUES ('568', '长白朝鲜族自治县', '56');
INSERT INTO `sys_district` VALUES ('569', '靖宇县', '56');
...
INSERT INTO `sys_district` VALUES ('604', '阿城区', '60');
...
INSERT INTO `sys_district` VALUES ('766', '铜山区', '76');
...
INSERT INTO `sys_district` VALUES ('779', '姑苏区', '78');
...
INSERT INTO `sys_district` VALUES ('786', '吴江区', '78');
...
INSERT INTO `sys_district` VALUES ('794', '通州区', '79');
...
INSERT INTO `sys_district` VALUES ('822', '江都区', '83');
...
INSERT INTO `sys_district` VALUES ('879', '南湖区', '90');
...
INSERT INTO `sys_district` VALUES ('942', '弋江区', '99');
INSERT INTO `sys_district` VALUES ('943', '鸠江区', '99');
INSERT INTO `sys_district` VALUES ('944', '三山区', '99');
...
INSERT INTO `sys_district` VALUES ('964', '博望区', '102');
...
INSERT INTO `sys_district` VALUES ('975', '宜秀区', '105');
...
INSERT INTO `sys_district` VALUES ('1378', '禹王台区', '153');
INSERT INTO `sys_district` VALUES ('1379', '金明区', '153');
...
INSERT INTO `sys_district` VALUES ('1565', '襄州区', '173');
...
INSERT INTO `sys_district` VALUES ('1631', '望城区', '183');
...
INSERT INTO `sys_district` VALUES ('1711', '零陵区', '193');
...
INSERT INTO `sys_district` VALUES ('1757', '南沙区', '197');
INSERT INTO `sys_district` VALUES ('1758', '萝岗区', '197');
...
INSERT INTO `sys_district` VALUES ('2009', '綦江区', '234');
INSERT INTO `sys_district` VALUES ('2010', '大足区', '234');
...
INSERT INTO `sys_district` VALUES ('2015', '江津区', '234');
...
INSERT INTO `sys_district` VALUES ('2092', '利州区', '241');
...
INSERT INTO `sys_district` VALUES ('2137', '南溪区', '247');
...
INSERT INTO `sys_district` VALUES ('2256', '碧江区', '260');
INSERT INTO `sys_district` VALUES ('2257', '万山区', '260');
INSERT INTO `sys_district` VALUES ('2258', '江口县', '260');
INSERT INTO `sys_district` VALUES ('2259', '玉屏侗族自治县', '260');
INSERT INTO `sys_district` VALUES ('2260', '石阡县', '260');
INSERT INTO `sys_district` VALUES ('2262', '思南县', '260');
INSERT INTO `sys_district` VALUES ('2263', '印江土家族苗族自治县', '260');
INSERT INTO `sys_district` VALUES ('2264', '德江县', '260');
...
INSERT INTO `sys_district` VALUES ('2362', '思茅区', '271');
INSERT INTO `sys_district` VALUES ('2363', '宁洱哈尼族彝族自治县', '271');
...
INSERT INTO `sys_district` VALUES ('2403', '文山市', '275');
...
INSERT INTO `sys_district` VALUES ('2427', '芒市', '278');
...
INSERT INTO `sys_district` VALUES ('2571', '吴起县', '293');
...
INSERT INTO `sys_district` VALUES ('2633', '秦州区', '302');
INSERT INTO `sys_district` VALUES ('2634', '麦积区', '302');
...
INSERT INTO `sys_district` VALUES ('2659', '瓜州县', '306');
...
INSERT INTO `sys_district` VALUES ('2774', '米东区', '325');
...
INSERT INTO `sys_district` VALUES ('2865', '滨海新区', '2');
INSERT INTO `sys_district` VALUES ('2866', '曹妃甸区', '4');
INSERT INTO `sys_district` VALUES ('2869', '庐江县', '98');
INSERT INTO `sys_district` VALUES ('2870', '巢湖市', '98');
INSERT INTO `sys_district` VALUES ('2871', '无为县', '99');
INSERT INTO `sys_district` VALUES ('2872', '当涂县', '102');
INSERT INTO `sys_district` VALUES ('2873', '含山县', '102');
INSERT INTO `sys_district` VALUES ('2874', '和县', '102');
INSERT INTO `sys_district` VALUES ('2875', '共青城市', '127');
INSERT INTO `sys_district` VALUES ('2876', '济源市', '168');
INSERT INTO `sys_district` VALUES ('2877', '随县', '180');
INSERT INTO `sys_district` VALUES ('2878', '增城市', '197');
INSERT INTO `sys_district` VALUES ('2879', '从化市', '197');
INSERT INTO `sys_district` VALUES ('2880', '合川区', '234');
INSERT INTO `sys_district` VALUES ('2881', '永川区', '234');
INSERT INTO `sys_district` VALUES ('2882', '南川区', '234');
INSERT INTO `sys_district` VALUES ('2883', '沿河土家族自治县', '260');
INSERT INTO `sys_district` VALUES ('2884', '松桃苗族自治县', '260');
INSERT INTO `sys_district` VALUES ('2885', '金昌市', '300');
INSERT INTO `sys_district` VALUES ('2886', '红寺堡区', '322');
...
CREATE TABLE `sys_province` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ProvinceName` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `Spell` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `FirstLetter` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `ShorName` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='省信息';

-- ----------------------------
-- Records of sys_province
-- ----------------------------
INSERT INTO `sys_province` VALUES ('1', '北京市', 'BeiJing', 'B', '京');
INSERT INTO `sys_province` VALUES ('2', '天津市', 'TianJin', 'T', '津');
INSERT INTO `sys_province` VALUES ('3', '河北省', 'HeBei', 'H', '冀');
INSERT INTO `sys_province` VALUES ('4', '山西省', 'ShanXi', 'S', '晋');
INSERT INTO `sys_province` VALUES ('5', '内蒙古自治区', 'NeiMengGu', 'N', '内蒙古');
INSERT INTO `sys_province` VALUES ('6', '辽宁省', 'LiaoNing', 'L', '辽');
INSERT INTO `sys_province` VALUES ('7', '吉林省', 'JiLin', 'J', '吉');
INSERT INTO `sys_province` VALUES ('8', '黑龙江省', 'HeiLongJiang', 'H', '黑');
INSERT INTO `sys_province` VALUES ('9', '上海市', 'ShangHai', 'S', '沪');
INSERT INTO `sys_province` VALUES ('10', '江苏省', 'JiangSu', 'J', '苏');
INSERT INTO `sys_province` VALUES ('11', '浙江省', 'ZheJiang', 'Z', '浙');
INSERT INTO `sys_province` VALUES ('12', '安徽省', 'AnHui', 'A', '皖');
INSERT INTO `sys_province` VALUES ('13', '福建省', 'FuJian', 'F', '闽');
INSERT INTO `sys_province` VALUES ('14', '江西省', 'JiangXi', 'J', '赣');
INSERT INTO `sys_province` VALUES ('15', '山东省', 'ShanDong', 'S', '鲁');
INSERT INTO `sys_province` VALUES ('16', '河南省', 'HeNan', 'H', '豫');
INSERT INTO `sys_province` VALUES ('17', '湖北省', 'HuBei', 'H', '鄂');
INSERT INTO `sys_province` VALUES ('18', '湖南省', 'HuNan', 'H', '湘');
INSERT INTO `sys_province` VALUES ('19', '广东省', 'GuangDong', 'G', '粤');
INSERT INTO `sys_province` VALUES ('20', '广西壮族自治区', 'GuangXiZhuangZu', 'G', '桂');
INSERT INTO `sys_province` VALUES ('21', '海南省', 'HaiNan', 'H', '琼');
INSERT INTO `sys_province` VALUES ('22', '重庆市', 'ZhongQing', 'Z', '渝');
INSERT INTO `sys_province` VALUES ('23', '四川省', 'SiChuan', 'S', '蜀');
INSERT INTO `sys_province` VALUES ('24', '贵州省', 'GuiZhou', 'G', '黔');
INSERT INTO `sys_province` VALUES ('25', '云南省', 'YunNan', 'Y', '滇');
INSERT INTO `sys_province` VALUES ('26', '西藏自治区', 'XiCang', 'X', '藏');
INSERT INTO `sys_province` VALUES ('27', '陕西省', 'ShanXi', 'S', '陕');
INSERT INTO `sys_province` VALUES ('28', '甘肃省', 'GanSu', 'G', '甘');
INSERT INTO `sys_province` VALUES ('29', '青海省', 'QingHai', 'Q', '青');
INSERT INTO `sys_province` VALUES ('30', '宁夏回族自治区', 'NingXiaHuiZu', 'N', '宁');
INSERT INTO `sys_province` VALUES ('31', '新疆维吾尔自治区', 'XinJiangWeiWuEr', 'X', '新');
INSERT INTO `sys_province` VALUES ('32', '香港特别行政区', 'XiangGangTeBieXingZhengQu', 'X', '港');
INSERT INTO `sys_province` VALUES ('33', '澳门特别行政区', 'AoMenTeBieXingZhengQu', 'A', '澳');
INSERT INTO `sys_province` VALUES ('34', '台湾省', 'TaiWan', 'T', '台');
...
CREATE TABLE `sys_role_auth` (
  ...
  `AuthID` int(20) NOT NULL COMMENT '权限ID',
  PRIMARY KEY (`ID`) USING BTREE
